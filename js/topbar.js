document.addEventListener("DOMContentLoaded", function() {
    ...
    <div class="row" id="linksTopbar">
        <div class="col-10 d-flex" style="align-items: center; background-color: rgb(14, 60, 76); color: white; height: 100%;">
            ...
            &emsp;<a class="linkPopUp" href="https://www.flickr.com/photos/200282744@N03/albums" title="flickr albums"><img height="45em" src="../img/icons/flickr.svg" alt="flickr official logo."></a>
        ...
        <div class="col d-flex" style="align-items: center; justify-content: center; background-color: rgb(76, 57, 2); height: 100%;">
    ...
    <div class="row" id="navTopbar" style="background: linear-gradient(to right, rgb(48, 40, 2), rgb(35, 38, 39))">
        <div class="col d-flex align-items-center justify-content-center" style="line-height: 20px; height: 100%">
            <a id="indexMenuButton" href="index.html" title="Homepage where recent or current projects/entries/news are showcased" style="text-decoration: none; color: rgb(202, 197, 190);">Home</a>&emsp;
            <a id="projectsMenuButton" href="projects.html" title="Projects of different kinds are highlighted, sometimes as a video, as a JS browser-app or as an entire webpage" style="text-decoration: none; color: rgb(202, 197, 190);">Projects</a>&emsp;
            <a href="#" title="I like cooking and it's nice to finally put my recipes together in a proper form" style="text-decoration: none; color: rgba(202, 197, 190, 0.1);">Recipes</a>&emsp;
            <a href="#" title="Devlogs and personal notes" style="text-decoration: none; color: rgba(202, 197, 190, 0.1);">Blog</a>&emsp;
            <a id="aboutMenuButton" href="about.html" title="Brief page about myself for anyone interested" style="text-decoration: none; color: rgb(202, 197, 190);">About me</a>&emsp;
        </div>
    </div>`; 
